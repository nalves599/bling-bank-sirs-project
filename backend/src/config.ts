...
export const MASTER_PASSWORD = process.env.MASTER_PASSWORD || 'SuperSecretPassword';
...
export const JWT_PRIVATE_KEY = process.env.JWT_PRIVATE_KEY || JWT_KEYS.privateKey;
